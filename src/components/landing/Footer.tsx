        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 pt-4">
            ...
            <div className="flex flex-col gap-5">
              ...
              {/* Email */}
              <a href="mailto:sales@shreeramtradersrxl.in" className="flex items-start gap-4 group transition-all duration-300 hover:translate-x-2">
                <div className="bg-gold/10 p-3 rounded-xl group-hover:bg-gold/20 transition-all duration-300 shrink-0 group-hover:scale-110">
                ...
                <div>
                  <p className="text-[10px] uppercase tracking-wider text-primary-foreground/50 font-bold mb-0.5">Email Us</p>
                  <p className="text-base font-medium text-white group-hover:text-gold transition-colors break-all">
